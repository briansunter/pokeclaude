...
3. **Card Database** (`data/pokemon_pocket_cards.csv`) - 3761 cards across 22 sets
...
├── data/
│   └── pokemon_pocket_cards.csv  # Card database (3,761 cards)
...
- **pokemon://cards/all** - Full database (3,761 cards)
...
- ✅ **3,761 total cards** across 22 sets (A1-A4b, B1-B4, P-A, P-B)
...
- **data/pokemon_pocket_cards.csv** - Card database (3,761 cards)
